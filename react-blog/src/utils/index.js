export const defaultAvatarUrl = 'https://s11.mogucdn.com/mlcdn/c45406/181105_60bdj928jdhjg9ehhg58hje1212ek_640x640.jpg';
 ...
 * @returns {Function}     返回调用函数
 */
export const debunce = function (fn, delay = 1000) {
  var timer;
  var context = this;
  return function () {
    if (timer) {
